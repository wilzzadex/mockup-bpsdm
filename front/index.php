				...
				<div class="container clearfix">
					...
					<nav id="primary-menu" style="border-bottom:none !important;">
						...
						<ul>
							...
							<li><a href="#">
									<div>Publikasi<i class="icon-angle-down"></i></div>
								</a>
								<ul>
									<li><a href="publikasi_berita.php">
											<div>Berita</div>
										</a></li>
									<li><a href="publikasi_siaran_pers.php">
											<div>Siaran Pers</div>
										</a></li>
									<li><a href="publikasi_infografis.php">
											<div>Infografis</div>
										</a></li>
									<li><a href="publikasi_event.php">
											<div>Event</div>
										</a></li>
							...
							<li><a href="#">
									<div>Galeri<i class="icon-angle-down"></i></div>
								</a>
								<ul>
									<li><a href="galeri_foto.php">
											<div>Foto</div>
										</a></li>
									<li><a href="galeri_video.php">
											<div>Video</div>
										</a></li>
								</ul>
							</li>
							...
							<li><a href="https://sipencatar.dephub.go.id/" target="_blank">
									<div>Penerimaan Taruna</div>
								</a>
							</li>
						</ul>
						<div id="top-search">
							...
							<form action="search.html" method="get">
								<input type="text" name="q" class="form-control" value="" placeholder="Cari Disini..">
							</form>
						</div><!-- #top-search end -->
									...
									<div class="iportfolio">
										<div class="portfolio-image ">
											<a href="#" data-toggle="modal" data-target=".bs-example-modal-lg">
												<center><img
														src="http://bpsdm.dephub.go.id/uploads/gambar_galeri/2018_10_05_103223_9af9f8c750ccd3841d8f689907566944.jpg"
														alt="Console Activity"></center>
											</a>
										</div>
										<div class="portfolio-desc">
								...
								<div class="oc-item">
									<div class="iportfolio">
										<div class="portfolio-image ">
											<a href="#" data-toggle="modal" data-target=".bs-example-modal-lg">
												<center><img
														src="http://bpsdm.dephub.go.id/uploads/gambar_galeri/2018_10_05_102950_7dc7e06c899cb0d6bdb96746d4f4f22e.jpg"
														alt="Console Activity"></center>
											</a>
										</div>
										<div class="portfolio-desc">
				...
				<div class="container clearfix">
					...
					<div class="tabs tabs-alt tabs-justify clearfix" id="tab-10">
						...
						<ul class="tab-nav clearfix">
							<li><a href="#tabs-37">Berita</a></li>
							<li><a href="#tabs-38">Siaran Pers</a></li>
							<li><a href="#tabs-39">Infografis</a></li>
							...
							<div class="tab-content clearfix" id="tabs-37">
								<div class="row">
									...
									<div class="col-lg-4 col-md-6 bottommargin">
										<div class="ipost clearfix">
											<div class="entry-image">
												<a href="#"><img class="image_fade" src="gambar/berita6.jpg" alt="Image"
														style="opacity: 1;"></a>
											</div>
											<div class="entry-title">
												<h3><a href="blog-single.html">TINGKATKAN PERLINDUNGAN LINGKUNGAN
														MARITIM, KEMENHUB-IMO SELENGGARAKAN TRAINING LEGAL, POLICY AND
														INTERNAL REFORM
													</a></h3>
											</div>
											...
											<div class="entry-content">
												<p>JAKARTA (29/7) – Kementerian Perhubungan c.q. Direktorat Jenderal
													Perhubungan Laut dan Badan Pengembangan Sumber Daya Manusia (BPSDM)
													Perhubungan bekerja sama dengan International Maritime Organization
													(IMO) menggelar pelatihan atau ...</p>
											</div>
									...
									<div class="col-lg-4 col-md-6 bottommargin">
										<div class="ipost clearfix">
											<div class="entry-image">
												<a href="#"><img class="image_fade" src="gambar/berita7.jpg" alt="Image"
														style="opacity: 1;"></a>
											</div>
											<div class="entry-title">
												<h3><a href="blog-single.html">PERINGATI HARDIKNAS MENHUB AJAK TARUNA
														MEMBUAT INOVASI DI BIDANG TRANSPORTASI</a></h3>
											</div>
											<ul class="entry-meta clearfix">
											...
											<div class="entry-content">
												<p>Jakarta (2/5) – Kalian para taruna harus bisa membuat terobosan dan
													inovasi baru di bidang transportasi. Hal tersebut disampaikan
													Menteri Perhubungan, Budi Karya Sumadi, saat memberikan kuliah umum
													kepada para Taruna Transportasi dalam peringatan Hari Pendidikan
													Nasional tahun 2019, di Ruang Mataram..</p>
											</div>
											<a href="#" class="more-link mt-3" style="color: #007dc2;">Read More</a>
									...
									<div class="col-lg-4 col-md-6 bottommargin">
										<div class="ipost clearfix">
											<div class="entry-image">
												<a href="#"><img class="image_fade" src="gambar/berita8.jpg" alt="Image"
														style="opacity: 1;"></a>
											</div>
											<div class="entry-title">
												<h3><a href="blog-single.html">LANTIK 354 PELAUT, KEPALA BPSDM
														PERHUBUNGAN AJAK KAUM PEREMPUAN IKUT MEMBANGUN MARITIM
														INDONESIA</a></h3>
											</div>
											<ul class="entry-meta clearfix">
											...
											<div class="entry-content">
												<p>Tangerang (4/5) - Saya harapkan perempuan tidak sungkan untuk ikut
													bersama sama melaksanakan dan ikut dalam pendidikan pelatihan di
													dunia maritim seperti pada sektor-sektor lainnya. Hal tersebut
													disampaikan oleh Kepala Badan Pengembangan Sumber Daya Manusia
													Perhubungan (BPSDMP), Umiyatun Hayati ...</p>
											</div>
										</div>
										<a href="#" class="more-link mt-3" style="color: #007dc2;">Read More</a>
								...
								<div id="related-portfolio" class="owl-carousel portfolio-carousel carousel-widget"
									...
									<div class="oc-item">
										<div class="iportfolio">
											...
											<div class="portfolio-image">
												<a href="portfolio-single.html">
													<img src="gambar/infografis1.png" alt="Console Activity">
												</a>
												<div class="portfolio-overlay">
													<a href="gambar/infografis1.png" class="left-icon"
														data-lightbox="image"><i class="icon-eye"></i></a>
													<a href="gambar/infografis1.png" class="right-icon" download=""><i
									...
									<div class="oc-item">
										<div class="iportfolio">
											<div class="portfolio-image">
												<a href="portfolio-single.html">
													<img src="gambar/infografis3.jpg" alt="Console Activity">
												</a>
												<div class="portfolio-overlay">
													<a href="gambar/infografis3.jpg" class="left-icon"
														data-lightbox="image"><i class="icon-eye"></i></a>
													<a href="gambar/infografis3.jpg" class="right-icon" download=""><i
															class="icon-download"></i></a>
												</div>
											</div>
											<div class="portfolio-desc">
									...
									<div class="oc-item">
										<div class="iportfolio">
											<div class="portfolio-image">
												<a href="portfolio-single.html">
													<img src="gambar/infografis2.jpg" alt="Console Activity">
												</a>
												<div class="portfolio-overlay">
													<a href="gambar/infografis2.jpg" class="left-icon"
														data-lightbox="image"><i class="icon-eye"></i></a>
													<a href="gambar/infografis2.jpg" class="right-icon" download=""><i
															class="icon-download"></i></a>
												</div>
											</div>
											<div class="portfolio-desc">
									...
									<div class="oc-item">
										<div class="iportfolio">
											<div class="portfolio-image">
												<a href="portfolio-single.html">
													<img src="gambar/infografis5.jpg" alt="Console Activity">
												</a>
												<div class="portfolio-overlay">
													<a href="gambar/infografis5.jpg" class="left-icon"
														data-lightbox="image"><i class="icon-eye"></i></a>
													<a href="gambar/infografis5.jpg" class="right-icon" download=""><i
															class="icon-download"></i></a>
												</div>
											</div>
											<div class="portfolio-desc">
