                ...
                <div class="panel-body">
                                        ...
                                        <form role="form" class="form-horizontal">
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" placeholder="pertanyaan" id="form-field-1" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <label for="">Jawaban</label>
                                                    <textarea class="ckeditor form-control" cols="30" rows="10"></textarea>
                                                </div>
                                            </div>
                                        </form>
                                        </p>
                                        ...
                                        <form role="form" class="form-horizontal">
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" placeholder="Question" id="form-field-1" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">
                    ...
                    <div class="row ">
                        <div class="col-md-12 space20">
                            ...
                            <a href="?menu=m_faq" class="btn btn-success add-row">
