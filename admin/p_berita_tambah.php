                ...
                <div class="panel-body">
                                        ...
                                        <form role="form" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <div class="kv-avatar ">
                                                        <input id="mediaIn" name="avatar" type="file" class="file-loading">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <form role="form" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div id="kv-avatar-errors" class="center-block" style="display:none"></div>
                                                    <div class="kv-avatar ">
                                                        <input id="mediaEn" name="avatar" type="file" class="file-loading">
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                    ...
                    <div class="row">
                        <div class="col-md-12 space20">
                            ...
                            <a href="?menu=tambah_berita" class="btn btn-success add-row">
                                Publish <i class="fa fa-bullhorn" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                </div>
