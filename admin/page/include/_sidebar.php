<div class="main-navigation navbar-collapse collapse">
    ...
    <ul class="main-navigation-menu">
        <li style="margin-top: 30px; margin-bottom: 20px;">
            <center><img src="gambar/13.png" style="height:100px"><br><br>
                BPSDM PERHUBUNGAN
            </center>
        </li>
        <li>
        ...
        <li>
            ...
            <ul class="sub-menu">
                <li>
                    <a href="?menu=m_slider">
                        <span class="title"> Slider </span>
                    </a>
                </li>
                <li>
                    <a href="?menu=h_sosial">
                        <span class="title"> Sosial Media </span>
                    </a>
                </li>
                <li>
                    <a href="?menu=h_alamat">
        ...
        <li>
            ...
            <ul class="sub-menu">
                ...
                <li>
                    <a href="?menu=struktur">
                        <span class="title"> Struktur Organisasi</span>
                    </a>
                </li>
                <li>
                    <a href="?menu=satuan_kerja">
        ...
        <li>
            ...
            <ul class="sub-menu">
                <li>
                    <a href="?menu=p_berita">
                        <span class="title"> Berita </span>
                    </a>
                </li>
                <li>
                    <a href="?menu=p_siaran_pers">
                        <span class="title"> Siaran Pers </span>
                    </a>
                </li>
                <li>
                    <a href="?menu=p_infografis">
